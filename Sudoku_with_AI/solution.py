...
rows = 'ABCDEFGHI'
cols = '123456789'
cols_reverse = cols[::-1] #reversing the column for diagonal2
...
def eliminate(values):
    """
    Go through all the boxes, and whenever there is a box with a value, eliminate 
    this value from the values of all its peers.
